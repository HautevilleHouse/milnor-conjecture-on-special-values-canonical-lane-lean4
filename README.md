# Milnor Conjecture on Special Values — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/milnor-conjecture-on-special-values-canonical-lane-mathlib.git
cd milnor-conjecture-on-special-values-canonical-lane-mathlib
lake exe
lake build
```
